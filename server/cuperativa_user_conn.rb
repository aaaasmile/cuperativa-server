...
require 'base64'
#require 'protocols/linetext2' #usare gem eventmachine 0.12.10 e questa linea 
                               #rimane commentata. Con 0.10.0 invece va inserita
                               # Nota che eventmachine 0.10.0 e 0.12.10 assieme non funzionano
