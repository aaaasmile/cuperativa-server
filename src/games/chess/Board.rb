...
class Board
  ...
  ## - check se la mossa � valida: 
  ##           - tocca al colore
  ##           - pezzi sono nella scacchiera
  ##           - non si va in scacco, 
  ##           - valida per il pezzo in linea teorica
  ##           - intralci altri pezzi
  ##           - destinazione non � occupata da pezzi del proprio colore
  ##           - se arroco valido
  ##           - se promozione � valida
  ##           - se enpassant � valida
  ##           - se la presa � valida
  ...
  def start_move_igorchess(argument)
    ...
    #              per vedere se si pu� evitare lo scacco
  end
